"""Unit tests for v9_3_btc_raw_lgb GHOST strategy.
...
from strategies.configs.v9_3_btc_raw_lgb import evaluate_v9_3_btc_raw_lgb
...
def _clear_consec_state():
    from strategies.configs import v9_3_btc_raw_lgb
    v9_3_btc_raw_lgb._consec_state.clear()
    yield
    v9_3_btc_raw_lgb._consec_state.clear()
...
class TestForwardCompat:
    def test_model_not_loaded_skips_cleanly(self):
        ...
        with _params():
            d = evaluate_v9_3_btc_raw_lgb(surface)
        assert d.action == "SKIP"
        assert d.skip_reason == "v9_3_btc_model_not_loaded"
        assert d.strategy_id == "v9_3_btc_raw_lgb"
...
class TestThresholds:
    def test_up_fires_at_0_72(self):
        ...
        assert d.direction == "UP"
        assert d.strategy_id == "v9_3_btc_raw_lgb"
        assert d.entry_reason == "v9_3_btc_raw_lgb_pass"
