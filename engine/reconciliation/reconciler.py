...
class CLOBReconciler:
    ...
    async def _poll_once(self) -> None:
        ...
        # 3. Track known-resolved condition IDs (resolution is now handled by
        # ReconcilePositionsUseCase in the sot_reconciler_loop — _resolve_position
        # has been removed; this loop only updates _known_resolved for state tracking)
        for cid, data in outcomes.items():
