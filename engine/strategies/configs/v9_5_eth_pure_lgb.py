...
Per-direction eval-band support (feat/v9_5-direction-split-bands, plan #806):
  ...
  Sweep analysis (RDS note #806): UP optimal at band 0-120, DOWN optimal
  at 30-90.  Example SRO to set these independently:
    eval_offset_min_up=0,   eval_offset_max_up=120
