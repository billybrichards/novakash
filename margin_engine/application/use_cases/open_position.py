...
class OpenPositionUseCase:
    ...
    def __init__(
        ...
        self._v4_strategy = V4Strategy(
            ...
            v5_ensemble_enabled=input.v5_ensemble_enabled,
            v5_ensemble_signal_source=input.v5_ensemble_signal_source,
            v5_ensemble_skip_on_fallback=input.v5_ensemble_skip_on_fallback,
            v5_ensemble_disagreement_threshold=input.v5_ensemble_disagreement_threshold,
