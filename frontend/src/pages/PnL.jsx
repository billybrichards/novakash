...
export default function PnL() {
  ...
  useEffect(() => {
    api.get('/api/pnl/cumulative').then(res => setCumulative(res.data.items || []));
    api.get('/api/pnl/daily').then(res => setDaily(res.data.items || []));
    api.get('/api/pnl/monthly').then(res => setMonthly(res.data.items || []));
    api.get('/api/pnl/by-strategy').then(res => setByStrategy(res.data));
  }, []);
