-- Migration: seed v9_5_eth_raw_lgb strategy row in strategy_configs
-- Date: 2026-05-22
-- Purpose: Belt-and-braces seed for the new v9_5_eth_raw_lgb strategy
--          ahead of the engine boot. The canonical write path is
--          StrategyRegistry.seed_registry_to_db() (see hub/db/migrations/
--          versions/20260417_03_strategy_configs.sql) which runs on engine
...
--
-- See also: migrations/add_probability_lgb_v9_5_eth.sql (peer migration —
...
INSERT INTO strategy_configs (
    ...
    'ETH',
    '5m',
    -- Raw YAML body — kept in sync with engine/strategies/configs/v9_5_eth_raw_lgb.yaml
...
WHERE strategy_id = 'v9_5_eth_raw_lgb';
