...
--   UP   when probability_lgb_v9_2_eth >= 0.82, eval_offset in [60, 90]
--     14d audit (#627):           92.9% WR on n=211 windows
--     38h post-PR-#582 (#629):    88.0% WR on n=25  (Wilson LB 70.0%)
--   DOWN intentionally NOT implemented (audit n=5, too thin to trust).
--
...
-- RDS data). [60, 90] = bet placed when 1-1.5 minutes remain in window.
--
