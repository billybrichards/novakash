-- Migration: seed v9_5_xrp_late_band_AB strategy row in strategy_configs
-- Date: 2026-05-24
-- Purpose: Belt-and-braces seed for the new v9_5_xrp_late_band_AB strategy
...
INSERT INTO strategy_configs (
    ...
    'v9_5_xrp_late_band_AB',
    '1.0.0',
    'GHOST',
    'XRP',
    '5m',
    -- Raw YAML body — kept in sync with engine/strategies/configs/v9_5_xrp_late_band_AB.yaml
    ...
    $$name: v9_5_xrp_late_band_AB
strategy_id: v9_5_xrp_late_band_AB
version: "1.0.0"
status: GHOST
mode: GHOST
asset: XRP
timescale: 5m
hooks_file: v9_5_xrp_late_band_AB.py
pre_gate_hook: evaluate_v9_5_xrp_late_band_AB
sizing:
  type: kelly
  fraction: 0.025
...
WHERE strategy_id = 'v9_5_xrp_late_band_AB';
